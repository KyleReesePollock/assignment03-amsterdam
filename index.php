...
<body class="home">
	<div class="container">
		...
		<div class="meg">
			...
			<p> My initital role for this assignment is infromaiton architect. As information architect I must prepare all the content
				and how it's arranged within each page and across pages. Design the navigation and how it's presented in any browser
				type and size. Lead team collaboration (Github) and manage the file structure – unless there is a Backend Hacker on the
				team. I will be ensure that there are no usability problems. That the structure layer (content) is coded in HTML so it
				is arranged and accessible in a way that makes sense for the content. That content structure(HTML)meets industry standards
				and best practices including W3C HTML validation within reason and that the team is coordinated and effective.
				<a href="mp-about.php">
				Read More</a>
			</p>
		</div>
		...
		<div class="an">
			...
			<p>My initital role for this assignment is coder. As coder I will be responsible for everything the user interacts with,
				...
				<a href="av-about.php"> Read More</a>
			</p>
		</div>
		...
		<div class="ber">
			...
			<p>My initital role for this assignment is design artist. As the artist I am responsible for everything the user sees, in
				...
				<a href="aw-about.php"> Read More</a>
			</p>
		</div>
